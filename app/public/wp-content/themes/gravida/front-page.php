  ...
  <div class="slider-wrapper theme-default">
    ...
    <div id="slidecaption<?php echo esc_attr($sln); ?>" class="nivo-html-caption">
      <div class="slide_info">
        <h1><a href="<?php echo esc_url(get_theme_mod('slide_link'.$sln)); ?>"><?php echo esc_html(get_theme_mod('slide_title'.$sln)); ?></a></h1>
...
<div class="feature-box-main site-aligner">
  ...
  <div class="feature-box <?php if($f%4==0){ ?>last<?php } ?>">
    ...
    <div class="clear"></div>
    <div class="feature-button"><?php esc_html_e('Read More','gravida'); ?></div>
  </div>
  </a><!-- feature-box -->
  <?php if($f%4==0) { ?>
  <div class="clear"></div>
